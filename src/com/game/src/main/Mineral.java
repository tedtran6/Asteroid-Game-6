...
public class Mineral implements Neutral{
	 ...
	 */
	public Mineral(double x, double y, SpriteCollection SpCol, Controller c, Game game){
		this.x = x;
		this.y = y;
		this.SpCol = SpCol;
		this.c = c;
	...
	public void render(Graphics g){
		g.drawImage(SpCol.mineral, (int)x, (int)y, null);
	}
	/**
